...
const handleSendMessage = async(e)=>{
    ...
    <div className='overflow-x-hidden mt-[-40px]' >
       ...
       <h1 className="text-tubeLight-effect text-[2rem]  sm:text-[1.75rem] md:text-[2.2rem] lg:text-[2.8rem] font-extrabold mx-auto w-fit">
         Get in Touch
       </h1>
</div>
...
<div className="flex justify-end mb-5" >
    {
        !loading ? <CoolMode><Button className="w-full sm:w-32" type="submit" >Grab your Slot</Button></CoolMode> : <button disabled type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center">
